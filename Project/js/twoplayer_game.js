    ...
    // Initialize the snake Enemy at a location
    ...
    // Variables
    var score = 0;              // Score
    var scoreEnemy = 0          // Score of an enemy
    ...
    function addApple()
    {
        ...
        while (!valid) 
        {
            ...
            for (var i=0; i<snake.segments.length; i++)
            {
                ...
                var sye = snakeEnemy.segments[i].y;
                var sxe = snakeEnemy.segments[i].x;
                
                // Check overlap
                if ((ax == sx && ay == sy)) || (ax == sxe && ay == sye))
                {
                    overlap = true;
                    break;
                }
    ...
    function updateGame(dt)
    {
        ...
        if (snakeEnemy.tryMove(dt))
        {
            ...
            var nxEnemy = nextmove.x;
            var nyEnemy = nextmove.y;
